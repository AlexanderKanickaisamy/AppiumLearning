...
//       Finger 1
        ...
        finger3.addAction(input3.createPointerMove(Duration.ofMillis(600), PointerInput.Origin.viewport(), endX, endY));
        ...
        startY = (int) (maxY * 0.5);
        endY = (int) (maxY * 0.25);
        PointerInput input4 = new PointerInput(PointerInput.Kind.TOUCH, "finger2");
        ...
        finger4.addAction(input4.createPointerMove(Duration.ofMillis(600), PointerInput.Origin.viewport(), endX, endY));
